...
export class FirebaseService {
  ...
  getProjectUsers(projectId) {
    return this.db.object(`projects/${projectId}/currentSprint/users`).valueChanges();
  }
  ...
  // 'https://firebasestorage.googleapis.com/v0/b/portfolio-5e570
  // .appspot.com/o/img%2F435530bg2-max.png?alt=media&token=13cdd15f-648d-4bd6-8c33-584561dde2ce';
  //   let self = this;
